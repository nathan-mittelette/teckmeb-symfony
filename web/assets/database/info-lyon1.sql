...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 21 mars 2019 à 18:22
...
CREATE TABLE IF NOT EXISTS `absence` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_765AE0C97A45358C` (`groupe_id`),
  KEY `IDX_765AE0C9CCAA91B` (`absence_type_id`),
...
(1, 2, 'Que penses-tu de ma réponse ?', '2018-12-01', 1),
(2, 7, 'Voici ce que je peux vous proposer:\r\nSi jamais je veux passer la variable a droite comment dois-je faire ? \r\nBonne journée merci', '2018-12-01', 1),
(3, 7, 'Bonjour Bérenger,\r\nJe ne suis pas apte a répondre à ta demande actuellement, je te propose de te rediriger vers M John il sera plus apte à te répondre.\r\nCordialement.\r\nBonne journée', '2018-12-01', 1),
(6, 857, 'Je me permet de répondre avant le professeur car au cours du dernier cours le professeur avait signalé qu\'il fallait le rendre pour demain', '2018-12-01', 3),
(7, 2, 'Je me permet de confirmer la réponse de Kheldin\r\nBonne soirée ;)', '2018-12-01', 3),
(9, 6, 'Vous êtes donc sur de ce que vous avancez ?', '2018-12-01', 3),
(10, 6, 'On refait un petit test ?', '2018-12-01', 3),
(11, 6, 'On espère que c\'est le dernier ^^', '2018-12-01', 3),
(12, 6, '...', '2018-12-01', 3),
(13, 6, 'Et l\'avant dernier ?', '2018-12-01', 3),
(14, 6, 'Et le dernier du coup ;)', '2018-12-01', 3),
(15, 857, 'On fait le dernier test sur les couleurs', '2018-12-12', 3),
(16, 858, 'C\'est finalement celui la le dernier test', '2018-12-12', 3),
(17, 858, 'On vérifie les notifications maintenant', '2018-12-12', 3),
(18, 2, 'Je vais répondre pour tester les notifications', '2019-01-23', 1),
(19, 2, 'Et nous faisons le test une dernière fois', '2019-01-23', 1);
...
CREATE TABLE IF NOT EXISTS `appointment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ptut_id` int(11) NOT NULL,
  `date` datetime NOT NULL,
  `comment` longtext COLLATE utf8_unicode_ci,
  `valide` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `IDX_FE38F844ADD804D4` (`ptut_id`)
...
INSERT INTO `appointment` (`id`, `ptut_id`, `date`, `comment`, `valide`) VALUES
(9, 4, '2019-01-24 11:07:00', NULL, 1);
...
CREATE TABLE IF NOT EXISTS `control` (
  ...
  `controlName` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `coefficient` decimal(10,0) NOT NULL,
  `divisor` decimal(10,0) NOT NULL,
  `median` decimal(10,2) DEFAULT NULL,
  `average` decimal(10,2) DEFAULT NULL,
  `controlDate` date NOT NULL,
  `education_id` int(11) DEFAULT NULL,
  `promo_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_EDDB2C4B65530F3F` (`control_type_id`),
  KEY `IDX_EDDB2C4B2CA1BD71` (`education_id`),
  KEY `IDX_EDDB2C4BD0C07AFF` (`promo_id`)
...
(1, 2, 'Ds de mi parcours', '1', '20', '13.17', '4.30', '2018-11-08', 1, NULL),
(2, 2, 'Ds mi parcours', '1', '20', '13.00', '6.16', '2018-11-08', 4, NULL),
(4, 2, 'Ds final', '1', '40', '22.50', '2.50', '2018-11-08', 4, NULL),
(5, 2, 'Ds de début de semestre', '1', '20', '19.00', '0.00', '2018-11-08', 7, NULL),
(8, 1, 'Promo', '1', '20', NULL, NULL, '2018-12-11', NULL, 3),
(10, 2, 'Premier DS de promo', '1', '20', NULL, NULL, '2019-01-17', 47, NULL),
(11, 1, 'DS Promo', '1', '20', NULL, NULL, '2019-01-22', NULL, 7),
(12, 2, 'ds', '1', '20', NULL, NULL, '2019-01-24', 47, NULL),
(13, 1, 'DS de promo', '1', '20', '9.96', '5.36', '2019-03-15', NULL, 23),
(15, 2, 'TEST', '1', '20', NULL, NULL, '2019-03-21', 61, NULL);
...
CREATE TABLE IF NOT EXISTS `controller` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_4CF2669A821747C2` (`nomBundle`),
  UNIQUE KEY `UNIQ_4CF2669ADAC2B516` (`nomController`),
  UNIQUE KEY `UNIQ_4CF2669A6CF0B508` (`nomRoute`),
  UNIQUE KEY `UNIQ_4CF2669AC7E84EB3` (`nomNavbar`)
...
INSERT INTO `controller` (`id`, `nomBundle`, `nomController`, `valide`, `nomRoute`, `nomNavbar`, `roles`) VALUES
(1, 'Mark', 'Mark', 1, 'teckmeb_mark_view', 'Notes', 'a:1:{i:0;s:13:\"ROLE_ETUDIANT\";}'),
(2, 'Absence', 'Absence', 1, 'teckmeb_absence_homepage', 'Absences', 'a:2:{i:0;s:16:\"ROLE_SECRETARIAT\";i:1;s:13:\"ROLE_ETUDIANT\";}'),
(3, 'Control', 'Control', 1, 'teckmeb_control_homepage', 'Controles', 'a:1:{i:0;s:12:\"ROLE_TEACHER\";}'),
(4, 'Ptut', 'Ptut', 1, 'teckmeb_ptut_homepage', 'Ptut', 'a:2:{i:0;s:12:\"ROLE_TEACHER\";i:1;s:13:\"ROLE_ETUDIANT\";}'),
(5, 'Question', 'Question', 1, 'teckmeb_question_homepage', 'Question', 'a:2:{i:0;s:12:\"ROLE_TEACHER\";i:1;s:13:\"ROLE_ETUDIANT\";}'),
(6, 'Suivi', 'Suivi', 1, 'teckmeb_suivi_homepage', 'Suivi', 'a:2:{i:0;s:12:\"ROLE_TEACHER\";i:1;s:16:\"ROLE_SECRETARIAT\";}'),
(7, 'TimeTable', 'Timetable', 1, 'teckmeb_time_table_homepage', 'Emploi du temps', 'a:2:{i:0;s:12:\"ROLE_TEACHER\";i:1;s:13:\"ROLE_ETUDIANT\";}');
...
CREATE TABLE IF NOT EXISTS `mark` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_6674F27132BEC70E` (`control_id`),
  KEY `IDX_6674F271CB944F1A` (`student_id`)
...
CREATE TABLE IF NOT EXISTS `notification` (
  ...
  `notsee` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
...
(33, 2, 'Bérangé MAYOUD vous a posé(e) une question', '2018-12-01 15:41:22', '/Question', 0),
(34, 2, 'Bérangé MAYOUD vous a posé(e) une question', '2018-12-01 15:47:00', '/Question', 0),
(35, 2, 'Bérangé MAYOUD vous a posé(e) une question', '2018-12-01 15:52:01', '/Question', 0),
(36, 2, 'Bérangé MAYOUD vous a posé(e) une question', '2018-12-01 15:54:14', '/Question', 0),
(37, 2, 'Thomas JACQUES vous a répondu', '2018-12-01 17:49:55', '/Question/3', 0),
(38, 2, 'Thomas JACQUES vous a répondu', '2018-12-01 18:15:54', '/Question/3', 0),
(39, 2, 'Thomas JACQUES vous a répondu', '2018-12-01 18:23:53', '/Question/3', 0),
...
(64, 2, 'Thomas JACQUES vous a répondu', '2018-12-01 19:06:57', '/Question/3', 0),
...
(89, 2, 'Thomas JACQUES a répondu', '2018-12-01 19:11:20', '/Question/3', 0),
...
(114, 2, 'Thomas JACQUES a répondu', '2018-12-01 19:11:40', '/Question/3', 0),
...
(139, 2, 'Kheldin ACHERCHOUR a répondu', '2018-12-12 09:31:40', '/Question/3', 0),
...
(164, 2, 'Matthias BASTIAN a répondu', '2018-12-12 09:32:22', '/Question/3', 0),
...
(189, 2, 'Matthias BASTIAN a répondu', '2018-12-12 09:37:02', '/Question/3', 0),
...
(201, 2, 'Vous avez une demande de rendez-vous', '2019-01-22 19:11:03', '/Ptut/view/2', 0),
...
(208, 969, 'Vous avez une nouvelle demande de Ptut', '2019-01-23 09:13:51', '/Ptut', 0),
...
(212, 2, 'Vous avez une demande de rendez-vous', '2019-01-23 10:10:21', '/Ptut/view/2', 0),
...
(217, 2, 'Richard Hardouin a répondu', '2019-01-23 23:11:36', '/Question/1', 0),
...
(226, 2, 'Vous avez une nouvelle demande de Ptut', '2019-01-24 10:06:18', '/Ptut', 0),
...
(229, 2, 'Vous avez une demande de rendez-vous', '2019-01-24 10:07:53', '/Ptut/view/4', 0),
...
--
-- Structure de la table `ptut`
--

DROP TABLE IF EXISTS `ptut`;
CREATE TABLE IF NOT EXISTS `ptut` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `teacher_id` int(11) NOT NULL,
  ...
  `description` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_1CA3879A41807E1D` (`teacher_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Déchargement des données de la table `ptut`
--

INSERT INTO `ptut` (`id`, `teacher_id`, `name`, `valide`, `description`) VALUES
(3, 4, 'BOT Pokemon GO', 1, 'Conception d\'un bot pour le jeu Pokemon Go qui irai traquer les pokemons tout seul'),
(4, 1, 'nom', 1, 'mm');

-- --------------------------------------------------------

--
-- Structure de la table `ptut_student`
--

DROP TABLE IF EXISTS `ptut_student`;
CREATE TABLE IF NOT EXISTS `ptut_student` (
  `ptut_id` int(11) NOT NULL,
  `student_id` int(11) NOT NULL,
  PRIMARY KEY (`ptut_id`,`student_id`),
  KEY `IDX_A022BC8ADD804D4` (`ptut_id`),
  KEY `IDX_A022BC8CB944F1A` (`student_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Déchargement des données de la table `ptut_student`
--

INSERT INTO `ptut_student` (`ptut_id`, `student_id`) VALUES
(3, 5),
(3, 677),
(4, 2),
(4, 5);
...
CREATE TABLE IF NOT EXISTS `question` (
  ...
  `groupe_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_B6F7494ECB944F1A` (`student_id`),
  KEY `IDX_B6F7494E41807E1D` (`teacher_id`),
  KEY `IDX_B6F7494E7A45358C` (`groupe_id`)
...
(1, 'secretariat', 'secretariat', 'nathan@iutinfo.fr', 'nathan@iutinfo.fr', 1, '8fIx3ca1YTVL7MsbNQt8dkSNKmddfuesmoBKnEeVYaU', 'S4TlswcJYIixRtGGKS80t5II5ApGeHDycl0bcyfTizv9dBsw2XJKecI9iAgwTxaFE1s6P0KKqkax8OU6AXtztw==', '2019-03-21 17:31:34', NULL, NULL, 'a:1:{i:0;s:16:\"ROLE_SECRETARIAT\";}', '', '', '', ''),
...
--
ALTER TABLE `absence`
  ADD CONSTRAINT `FK_765AE0C97A45358C` FOREIGN KEY (`groupe_id`) REFERENCES `groupe` (`id`),
  ADD CONSTRAINT `FK_765AE0C9CB944F1A` FOREIGN KEY (`student_id`) REFERENCES `student` (`id`),
  ADD CONSTRAINT `FK_765AE0C9CCAA91B` FOREIGN KEY (`absence_type_id`) REFERENCES `absence_type` (`id`);
...
ALTER TABLE `appointment`
  ADD CONSTRAINT `FK_FE38F844ADD804D4` FOREIGN KEY (`ptut_id`) REFERENCES `ptut` (`id`);

--
-- Contraintes pour la table `control`
--
ALTER TABLE `control`
  ADD CONSTRAINT `FK_EDDB2C4B2CA1BD71` FOREIGN KEY (`education_id`) REFERENCES `education` (`id`),
  ADD CONSTRAINT `FK_EDDB2C4B65530F3F` FOREIGN KEY (`control_type_id`) REFERENCES `control_type` (`id`),
  ADD CONSTRAINT `FK_EDDB2C4BD0C07AFF` FOREIGN KEY (`promo_id`) REFERENCES `promo` (`id`);

--
-- Contraintes pour la table `course`
--
ALTER TABLE `course`
  ADD CONSTRAINT `FK_169E6FB9CD8F897F` FOREIGN KEY (`course_type_id`) REFERENCES `course_type` (`id`);

--
-- Contraintes pour la table `course_teaching_unit`
--
ALTER TABLE `course_teaching_unit`
  ADD CONSTRAINT `FK_C14E2F92F82B390` FOREIGN KEY (`teaching_unit_id`) REFERENCES `teaching_unit` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_C14E2F9591CC992` FOREIGN KEY (`course_id`) REFERENCES `course` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `education`
--
ALTER TABLE `education`
  ADD CONSTRAINT `FK_DB0A5ED223EDC87` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`id`),
  ADD CONSTRAINT `FK_DB0A5ED241807E1D` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`id`),
  ADD CONSTRAINT `FK_DB0A5ED27A45358C` FOREIGN KEY (`groupe_id`) REFERENCES `groupe` (`id`);

--
-- Contraintes pour la table `groupe`
--
ALTER TABLE `groupe`
  ADD CONSTRAINT `FK_4B98C215577AFDB` FOREIGN KEY (`semestre_id`) REFERENCES `semestre` (`id`),
  ADD CONSTRAINT `FK_4B98C21F717C8DA` FOREIGN KEY (`group_name_id`) REFERENCES `choix_groupe` (`id`);

--
-- Contraintes pour la table `groupe_student`
--
ALTER TABLE `groupe_student`
  ADD CONSTRAINT `FK_7144487D7A45358C` FOREIGN KEY (`groupe_id`) REFERENCES `groupe` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_7144487DCB944F1A` FOREIGN KEY (`student_id`) REFERENCES `student` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `mark`
--
ALTER TABLE `mark`
  ADD CONSTRAINT `FK_6674F27132BEC70E` FOREIGN KEY (`control_id`) REFERENCES `control` (`id`),
  ADD CONSTRAINT `FK_6674F271CB944F1A` FOREIGN KEY (`student_id`) REFERENCES `student` (`id`);

--
-- Contraintes pour la table `module_subject`
--
ALTER TABLE `module_subject`
  ADD CONSTRAINT `FK_50B5006323EDC87` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_50B50063AFC2B591` FOREIGN KEY (`module_id`) REFERENCES `module` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `promo`
  ADD CONSTRAINT `FK_B0139AFB23EDC87` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`id`),
  ADD CONSTRAINT `FK_B0139AFB5577AFDB` FOREIGN KEY (`semestre_id`) REFERENCES `semestre` (`id`);

--
-- Contraintes pour la table `ptut`
--
ALTER TABLE `ptut`
  ADD CONSTRAINT `FK_1CA3879A41807E1D` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`id`);

--
-- Contraintes pour la table `ptut_student`
--
ALTER TABLE `ptut_student`
  ADD CONSTRAINT `FK_A022BC8ADD804D4` FOREIGN KEY (`ptut_id`) REFERENCES `ptut` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_A022BC8CB944F1A` FOREIGN KEY (`student_id`) REFERENCES `student` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `question`
--
ALTER TABLE `question`
  ADD CONSTRAINT `FK_B6F7494E41807E1D` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`id`),
  ADD CONSTRAINT `FK_B6F7494E7A45358C` FOREIGN KEY (`groupe_id`) REFERENCES `groupe` (`id`),
  ADD CONSTRAINT `FK_B6F7494ECB944F1A` FOREIGN KEY (`student_id`) REFERENCES `student` (`id`);

--
-- Contraintes pour la table `secretariat`
--
ALTER TABLE `secretariat`
  ADD CONSTRAINT `FK_F0C364B5A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- Contraintes pour la table `semestre`
--
ALTER TABLE `semestre`
  ADD CONSTRAINT `FK_71688FBC591CC992` FOREIGN KEY (`course_id`) REFERENCES `course` (`id`);
...
--
-- Contraintes pour la table `teaching_unit_module`
--
ALTER TABLE `teaching_unit_module`
  ADD CONSTRAINT `FK_7D7B1F52F82B390` FOREIGN KEY (`teaching_unit_id`) REFERENCES `teaching_unit` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_7D7B1F5AFC2B591` FOREIGN KEY (`module_id`) REFERENCES `module` (`id`) ON DELETE CASCADE;
